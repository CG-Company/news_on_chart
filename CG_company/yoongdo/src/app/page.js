        ...
        <main className="p-6">
          ...
          {!apiHealthy && (
            <div className="mb-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-yellow-800">API 서버 연결 불안정</p>
                  <p className="text-xs text-yellow-700 mt-1">일부 기능이 제한될 수 있습니다. 로컬 데이터를 사용합니다.</p>
                </div>
              </div>
            </div>
          )}
          ...
          <ErrorBoundary name="StockCards">
            {isLoadingStock ? (
              ...
              <StockCards currentStock={{ ticker, tickerName }} stockData={stockData} />
            )}
          </ErrorBoundary>
          ...
          <div className="mt-6 bg-gray-100 rounded-lg p-4">
            <h4 className="text-sm font-medium text-gray-700 mb-2">🔧 시스템 상태</h4>
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mt-6 bg-blue-50 rounded-lg p-4">
              <h4 className="text-sm font-medium text-blue-700 mb-2">🔧 개발 정보</h4>
              <div className="text-xs text-blue-600 space-y-1">
                ...
                <div>로딩 상태: 주식({isLoadingStock ? '로딩 중' : '완료'}) | 티커({isLoadingTicker ? '로딩 중' : '완료'})</div>
                <div className="text-green-600 font-medium">✅ 모든 최적화 적용 완료</div>
                <div className="text-blue-600 font-medium">🚀 에러 처리 및 검증 강화</div>
                <div className="text-purple-600 font-medium">🛡️ ErrorBoundary로 안정성 확보</div>
              </div>
            </div>
          )}
        </main>
