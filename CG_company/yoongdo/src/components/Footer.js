...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-50 border-t border-gray-200 py-2 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-stretch gap-2">
        {/* 왼쪽: 로고 (더 작게, 세로 중앙) */}
        ...
        {/* 가운데: 회사 정보 */}
        <div className="flex-1 flex flex-col justify-center items-center text-center min-w-[220px] gap-0">
        ...
        {/* 오른쪽: 고객센터 */}
        <div className="flex-1 flex flex-col items-center md:items-end justify-center min-w-[180px] gap-0">
          ...
          <select className="mt-0.5 border rounded px-2 py-0.5 text-xs text-gray-600">
