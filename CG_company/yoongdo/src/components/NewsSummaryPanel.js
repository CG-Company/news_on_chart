...
return (
<div className="bg-white border border-gray-200 rounded-xl p-4 mb-4 w-full max-w-4xl ml-0" style={{marginLeft: 0, marginRight: 'auto'}}>
    {/* 상단 강조 바 + 기간 버튼 오른쪽 */}
    <div style={{
    display: "flex",
    alignItems: "center",
    ...
    <div style={{
        ...
        {[
            ...
            <button
                ...
                style={{
                    background: summaryPeriod === opt.value ? "#fff" : "transparent",
                    color: "#22223b",
                    fontWeight: 400,
                    fontSize: 14,
                    border: "none",
                    ...
                    padding: "4px 14px",
                    marginRight: 2,
                    boxShadow: summaryPeriod === opt.value ? "0 1px 4px 0 rgba(0,0,0,0.04)" : "none",
